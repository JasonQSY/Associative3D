...
# roi pooling layers
# 1. roi_pool_torch: torchvision implementation with native backend support
# 2. roi_pool_py: python implementation
# 3. utils.roi_pooling: (deprecated) pytorch extension
from . import roi_pool_torch as roi_pool
...
#flags.DEFINE_boolean('cython_roi', False, 'Use cython roi')
